...
$sql= "SELECT COUNT(*) FROM surat_masuk where kategori_masuk='Surat perintah'";
$hasil=mysql_query($sql);
$data=mysql_fetch_array($hasil);

$sql2= "SELECT COUNT(*) FROM surat_masuk where kategori_masuk='Surat Undangan'";
    ...
    <script type="text/javascript">
        FusionCharts.ready(function() {
            var revenueChart = new FusionCharts({
                ...
                "dataSource": {
                    "chart": {
                        "caption": "Grafik tingkat surat masuk per kategori",
                        "subCaption": "Tahun 2018",
                        "xAxisName": "Jenis surat",
                        "yAxisName": "Jumlah",
                        "theme": "fint",
...
-->
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Surat Masuk
            <small>Grafik surat masuk per kategori</small>
          </h1>
          <ol class="breadcrumb">
        ...
        <div class="box box-primary">
          <div class="box-header">
            <h3 class="box-title">Tampilan Grafik</h3>                                    
          </div>
          <div class="row">
            <div class="col-md-6">
