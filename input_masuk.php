...
<!--ini script yang menuntut pengguna sistem untuk login jika belum login-->
...
<!-- untuk tambahan script simpan masuk -->
...
<div class="row">
              ...
              <div class="box box-primary">
                ...
                <div class="panel panel-success">
                    <div class="panel-heading">
                        Silahkan Input Data Surat Masuk
                    </div>
			...
			if($_POST['upload']){
				...
				// ini adalah penambahan variabel dari input tambahan
				// untuk informasi surat masuk

				$no_masuk = $_POST['no_masuk'];
				$pengirim = $_POST['pengirim'];
				$kategori_masuk = $_POST['kategori_masuk'];
				...
				if(in_array($file_ext, $allowed_ext) === true){
					if($file_size < 10044070){
						...
						$in = mysql_query("INSERT INTO surat_masuk VALUES(NULL, '$tgl', '$nama', '$file_ext', '$file_size', '$lokasi' , '$no_masuk' , '$pengirim' , '$kategori_masuk' , '$ket_masuk')");
						if($in){
            ...
            <form action="" method="post" enctype="multipart/form-data" role="form">
                    <div class="form-group">
                      ...
                      <input name="nama" class="form-control" id="exampleInputEmail1" placeholder="Masukkan Nama surat">
                    </div>            
                    <div class="form-group">
                      <label for="">No Surat :</label>
                      <input name="no_masuk" class="form-control" id="exampleInputEmail1" placeholder="Masukkan Nomor Surat">
                    </div>                                
                    <div class="form-group">
                      <label for="">Pengirim :</label>
                      <input name="pengirim" class="form-control" id="exampleInputEmail1" placeholder="Masukkan Nama Pengirim">
                    </div>                                                    
                    <div class="form-group">
                      <label>Keterangan</label>
                      <textarea name="ket_masuk" class="form-control" rows="3" placeholder="Silahkan Masukkan Keterangan ..."></textarea>
                    </div>                    
                  <div class="form-group">
                    <label>Kategori Surat</label>
                    <select name="kategori_masuk" class="form-control select2" style="width: 100%;">
                      <option selected="selected" value="Surat Keputusan">Surat Keputusan</option>
            ...
            <table width="100%" align="center" border="0" bgcolor="#eee" cellpadding="2" cellspacing="0">
                <tr>
                	<td><b>Pilih File :</b><input type="file" name="file" required /></td>
                </tr>
                <tr>
                	<td>&nbsp;</td><td>&nbsp;</td>
                </tr>
                <tr>
                <div class="form-group">
                  <td><input type="submit" name="upload" value="Upload" class="btn btn-success glyphicon glyphicon-tags"/></td>                  
                </div>
                </tr>
            </table>
            </form>
