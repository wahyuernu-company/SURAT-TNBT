      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview"><a href="#"><i class="fa fa-link"></i> <span>Surat Masuk</span></a>
            ...
            <div class="row">
                ...
                <div class="panel panel-success">
                    <div class="panel-heading">
                        Silahkan sesuaikan perubahan data
                    </div>
                    <div class="panel-body">
                    <form method="post" action="proses_ubah_masuk.php">
                    <div class="form-group">
                        <label>nama : </label>
                        <input type="text" name="nama_file" value= "<?php echo $data['nama_file'];?>" class="form-control" />
                    </div>
                    <div class="form-group">    
                        <label>no surat masuk :  </label>
                        <input type="text" name="no_masuk" value= "<?php echo $data['no_masuk'];?>" class="form-control" />
                    </div>
                    <div class="form-group">
                        <label>pengirim :  </label>
                        <input type="text" name="pengirim" value= "<?php echo $data['pengirim'];?>" class="form-control" /> 
                    </div>                      
                    <div class="form-group">
                        <label>kategori_masuk :  </label>
                        <input type="text" name="kategori_masuk" value= "<?php echo $data['kategori_masuk'];?>" class="form-control" /> 
                    </div>                                          
                    <div class="form-group">
                        ...
                        <hr />
                    <div class="form-group">
                    <button type="submit" class="btn btn-success glyphicon glyphicon-tags" > SIMPAN</button>
                    </div>
                    <div class="panel-footer text-muted">
                        <strong>Note : </strong>Ubahlah sesuai dengan yang diinginkan
                    </div>
                    </form>
                </div>
                     </div>
